TEGRA3_SEPOLICY_COMPAT_BASE := hardware/nvidia/tegra3/sepolicy/compat
...
BOARD_SEPOLICY_DIRS += $(TEGRA3_SEPOLICY_COMPAT_BASE)/mm
endif

# >=7.1
ifeq ($(shell test $(PLATFORM_SDK_VERSION) -ge 25 || echo 1),)
BOARD_SEPOLICY_M4DEFS += android_api_mm_or_later=true
BOARD_SEPOLICY_M4DEFS += android_api_n_mr1_or_later=true
endif
